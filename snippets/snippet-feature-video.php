...
<?php   
$hero_image_smartphone = get_the_post_thumbnail_url(get_the_ID(),'thumbnail'); 
$hero_image_tablet = get_the_post_thumbnail_url(get_the_ID(),'medium'); 
$hero_image_desktop = get_the_post_thumbnail_url(get_the_ID(),'medium_large'); 
$hero_image_desktop_plus = get_the_post_thumbnail_url(get_the_ID(),'large'); 
?>
...
<figure class="feature feature-image">
    <picture>
        ...
        data-srcset="<?php echo $hero_image_desktop_plus; ?>">
        <!-- desktop (most) -->
        <source type="image/jpg" media="(min-width: 461px) and (max-width: 1600px)"
        data-srcset="<?php echo $hero_image_desktop; ?>">
        <!-- tablet (landscape) -->
        ...
        data-srcset="<?php echo $hero_image_tablet; ?>">
        <!-- Smartphone (portrait) -->
        <source type="image/jpg" media="(max-width: 460px)"
        data-srcset="<?php echo $hero_image_smartphone; ?>">
            <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" class="lazyload" loading="lazy" data-src="<?php echo $hero_image_smartphone; ?>" alt="<?php echo esc_attr( get_the_title() ); ?>"  />
    </picture>
</figure>
