<link rel="preload" as="font" href="<?php echo get_template_directory_uri(); ?>/fonts/Geomanist-Regular.woff2"
    type="font/woff2" crossorigin="anonymous">
<link rel="preload" as="font" href="<?php echo get_template_directory_uri(); ?>/fonts/Geomanist-Bold.woff2"
    type="font/woff2" crossorigin="anonymous">
<link rel="preload" as="font" href="<?php echo get_template_directory_uri(); ?>/fonts/Geomanist-Black.woff2"
    type="font/woff2" crossorigin="anonymous">
<?php echo "<style>
@font-face {
